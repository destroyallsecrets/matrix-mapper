...
import { Cpu, Plus, Settings, Grid, Layers, X, MonitorUp, MousePointer2, Activity, Waves, Zap } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  // Initial Boot
  useEffect(() => {
    addLog("Matrix Spatial Mapper OS v5.2 initialized...", "system");
  ...
  return (
    <div className="relative w-full h-[100dvh] overflow-hidden bg-black text-green-500 font-mono flex flex-col">
      ...
      <div className="relative z-10 w-full h-full max-w-[1920px] mx-auto p-2 md:p-4 flex flex-col gap-4">
        ...
        {/* Backdrop for Menu - Placed here to share stacking context with Header */}
        {isMenuOpen && (
            <div 
        ...
        {/* Header */}
        <header className="flex justify-between items-center border-b border-green-900 pb-2 bg-black/50 backdrop-blur-md relative z-50 shrink-0">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  {/* Dropdown Menu */}
                  {isMenuOpen && (
                    <div className="absolute top-full right-0 mt-2 w-[85vw] max-w-[340px] bg-black/95 border border-green-600 shadow-[0_0_25px_rgba(0,255,0,0.2)] rounded z-50 overflow-hidden backdrop-blur-xl animate-in fade-in slide-in-from-top-2 duration-200">
                      <div className="p-3 border-b border-green-900 text-xs font-bold text-green-700 uppercase flex justify-between items-center bg-green-900/10">
                        <span>System Configuration</span>
                        <Settings className="w-3 h-3" />
                      </div>
                      <div className="p-4 space-y-5 h-[70vh] overflow-y-auto">
                        
                        {/* Interactive Zoom */}
                        <label className="flex items-center justify-between cursor-pointer active:bg-green-900/20 p-2 -mx-2 rounded transition-colors group touch-manipulation">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative h-6 flex items-center">
                            <div className="absolute w-full h-1.5 bg-green-900/50 rounded-full overflow-hidden">
                               <div className="h-full bg-green-500" style={{ width: `${sensitivity}%` }} />
                            </div>
                            ...
                            <div className="absolute h-4 w-4 bg-black border-2 border-green-500 rounded-full shadow-[0_0_5px_#0f0] pointer-events-none transform -translate-x-1/2" style={{ left: `${sensitivity}%` }} />
                          </div>
                        </div>

                        {/* 2. Light Refraction (Decay) */}
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                          ...
                          <div className="relative h-6 flex items-center">
                            <div className="absolute w-full h-1.5 bg-green-900/50 rounded-full overflow-hidden">
                               <div className="h-full bg-cyan-500" style={{ width: `${refraction}%` }} />
                            </div>
                            ...
                            <div className="absolute h-4 w-4 bg-black border-2 border-cyan-500 rounded-full shadow-[0_0_5px_cyan] pointer-events-none transform -translate-x-1/2" style={{ left: `${refraction}%` }} />
                          </div>
                          <div className="text-[9px] text-green-700 text-right">High refraction = Long signal trails</div>
                        </div>

                         {/* 3. Pulse Frequency (Range) */}
                         <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                          ...
                          <div className="relative h-6 flex items-center">
                            <div className="absolute w-full h-1.5 bg-green-900/50 rounded-full overflow-hidden">
                               <div className="h-full bg-yellow-500" style={{ width: `${range}%` }} />
                            </div>
                            ...
                            <div className="absolute h-4 w-4 bg-black border-2 border-yellow-500 rounded-full shadow-[0_0_5px_yellow] pointer-events-none transform -translate-x-1/2" style={{ left: `${range}%` }} />
                          </div>
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative h-6 flex items-center">
                            <div className="absolute w-full h-1.5 bg-green-900/50 rounded-full overflow-hidden">
                               <div className="h-full bg-green-600" style={{ width: `${density}%` }} />
                            </div>
                            ...
                            <div className="absolute h-4 w-4 bg-black border-2 border-green-500 rounded-full shadow-[0_0_5px_#0f0] pointer-events-none transform -translate-x-1/2" style={{ left: `${density}%` }} />
                          </div>
                        </div>
          ...
          <div className="text-[10px] md:text-xs text-green-700 flex flex-col items-end leading-tight">
             ...
             <span>PULSE: {range} | ZOOM: {zoomEnabled ? 'ON' : 'OFF'}</span>
          </div>
        </header>
